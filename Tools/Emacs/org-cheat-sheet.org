...
Blocks (like QUOTE above) can be easily inserted with C-c C-,
...
| Japan          |         1 |        18 |  18.0 |
|----------------+-----------+-----------+-------|
#+TBLFM: $4=$3/$2;%.# org-table-transpose-table-at-point will transpose a table!
